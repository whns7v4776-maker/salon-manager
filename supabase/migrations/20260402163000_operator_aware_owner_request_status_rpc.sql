...
begin
  ...
  return public.update_owner_booking_request_status_core(v_workspace_id, p_request_id, p_status);
end;
$$;
...
grant execute on function public.update_owner_booking_request_status(uuid, public.request_status) to authenticated;
grant execute on function public.update_owner_booking_request_status_by_email(citext, text, uuid, public.request_status) to anon;
grant execute on function public.update_owner_booking_request_status_by_email(citext, text, uuid, public.request_status) to authenticated;
