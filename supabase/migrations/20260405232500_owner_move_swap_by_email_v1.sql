create or replace function public.move_owner_appointment_by_email_v1(
...
create or replace function public.swap_owner_appointments_by_email_v1(
  p_owner_email citext,
  p_salon_code text,
...
grant execute on function public.move_owner_appointment_by_email_v1(citext, text, uuid, date, time) to anon;
grant execute on function public.move_owner_appointment_by_email_v1(citext, text, uuid, date, time) to authenticated;
grant execute on function public.swap_owner_appointments_by_email_v1(citext, text, uuid, uuid) to anon;
grant execute on function public.swap_owner_appointments_by_email_v1(citext, text, uuid, uuid) to authenticated;
