    ...
    return (
      <Redirect
        href={{
          pathname: '/cliente',
          params: {
            salon: Array.isArray(searchParams.salon) ? searchParams.salon[0] : searchParams.salon,
            mode: Array.isArray(searchParams.mode) ? searchParams.mode[0] : searchParams.mode,
            email: Array.isArray(searchParams.email) ? searchParams.email[0] : searchParams.email,
            phone: Array.isArray(searchParams.phone) ? searchParams.phone[0] : searchParams.phone,
            autologin: Array.isArray(searchParams.autologin)
              ? searchParams.autologin[0]
              : searchParams.autologin,
            biometric: Array.isArray(searchParams.biometric)
